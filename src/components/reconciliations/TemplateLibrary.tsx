...
import {
  Plus, Search, Filter, Eye, Copy, Archive, Rocket, MoreHorizontal, FileEdit,
} from 'lucide-react';
...
export function TemplateLibrary() {
  ...
  const { duplicateTemplate, archiveTemplate, publishTemplate } = useTemplateMutations();
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3 items-center justify-between">
        ...
        <Button onClick={() => navigate('/reconciliations/templates/new')}>
              ...
              {isLoading ? (
                ...
                filtered.map((t, i) => (
                  <motion.tr
                    ...
                    onClick={() => navigate(`/reconciliations/templates/${t.id}`)}
                  >
                    <TableCell>
                      <div>
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" onClick={(e) => e.stopPropagation()}>
                          <DropdownMenuItem onClick={() => navigate(`/reconciliations/templates/${t.id}`)}>
